...
filename_input = 'bedrock_model' # .in file
filename_materials = 'bedrock_model_materials' # material file
path_to_h5 = infileFolder+'bedrock' # path

# Create path to file ---------------------------------------------
path_to_input = infileFolder + filename_input
path_to_materials = infileFolder+filename_materials
...
# Generate .in file ------------------------------------------------
WriteInputFile(path_to_input, path_to_materials, path_to_h5, xsize, ysize, discrete, freq, trans, recei, time_window)